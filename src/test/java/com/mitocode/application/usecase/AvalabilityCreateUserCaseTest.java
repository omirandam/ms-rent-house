...
import com.renthouse.omar.application.usecase.AvailabilityCreateUseCase;
...
public class AvalabilityCreateUserCaseTest {
	...
	private IAvalabilityCreate_in create_in = new AvailabilityCreateUseCase(avalability_out);
